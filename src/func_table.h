...
static struct {
    ...
    // {totinit, tot, totss, totpred},  //files deleted
    {CTinit, CT, CTss, CTpred},
    // {fitinit, fit, fitss, fitpred},  //files deleted
    // {tstatsinit, tstats, tstatsss, tstatspred}, //files deleted
    // {totDinit, totD, totDss, totDpred},  //files deleted
    {CTDinit, CTD, CTDss, CTDpred},
    // {fitDinit, fitD, fitDss, fitDpred},  //files deleted
    // {tstatsDinit, tstatsD, tstatsDss, tstatsDpred},  //files deleted
    // {userinit, user, userss, userpred},  //files deleted
    // {userDinit, userD, userDss, userDpred},  //files deleted
    // {policyinit, policy, policyss, policypred}, //files deleted
    // {policyDinit, policyD, policyDss, policyDpred}, //files deleted
};
